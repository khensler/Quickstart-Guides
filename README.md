...
- [Fibre Channel Quick Start](distributions/hpe-vme/fc/QUICKSTART.md) - FC with GFS2 datastores for HPE VME clusters (CLI-only)
- [Fibre Channel Best Practices](distributions/hpe-vme/fc/BEST-PRACTICES.md) - FC best practices for HPE VME
