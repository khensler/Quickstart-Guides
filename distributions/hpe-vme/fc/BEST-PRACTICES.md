...
HPE VM Essentials hypervisor nodes run Ubuntu. Package management and HBA driver loading follow the same patterns as [Debian/Ubuntu FC Best Practices](../../debian/fc/BEST-PRACTICES.md).
