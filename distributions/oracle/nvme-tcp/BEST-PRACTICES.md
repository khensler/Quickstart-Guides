...
**Minimal firewall rules for storage:**
```bash
# Create dedicated zone for storage
...
# Allow NVMe-TCP port in public zone (if needed)
sudo firewall-cmd --permanent --zone=public --add-port=4420/tcp
