...
Guide for configuring iSCSI storage on RHEL-based systems (RHEL 8/9, Rocky Linux, AlmaLinux, CentOS Stream).
...
| Term | Definition |
|------|------------|
| **IQN** | iSCSI Qualified Name - unique identifier for initiators and targets (e.g., `iqn.1994-05.com.redhat:server01`) |
...
### Using NetworkManager (nmcli) - Recommended for RHEL
