...
**Important:** Both approaches work correctly with NVMe-TCP multipath. NVMe-TCP uses `--host-iface` and `--host-traddr` parameters to bind connections to specific interfaces.
