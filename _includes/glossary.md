...
### fast_io_fail_tmo
iSCSI/multipath parameter specifying how quickly to mark a path as failed after an I/O error. Recommended: **10** seconds.

### dev_loss_tmo
iSCSI/multipath parameter specifying how long to wait before removing a failed device entirely. Recommended: **60** seconds. Should be longer than fast_io_fail_tmo.
